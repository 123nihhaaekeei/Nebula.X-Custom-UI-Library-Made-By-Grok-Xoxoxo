local library, themes = (function()
    ...
    function library:tween(obj, properties) 
        local tween = tween_service:Create(obj, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut, 0, false, 0), properties):Play()
        return tween
    end 
    ...
    function library:update_glow_strength(strength)
        themes.preset.glow_strength = strength
        for _, property in next, themes.utility.glow do 
            for _, object in next, property do 
                if object:IsA("ImageLabel") then
                    object.ImageTransparency = 1 - strength
                end
            end 
        end 
    end
    ...
    function library:tool_tip(options) 
        ...
        if cfg.path then 
            ...
            local UIGradient = library:create("UIGradient", {
                ...
                Name = "",
                Color = rgbseq{rgbkey(0, rgb(8, 8, 8)), rgbkey(1, rgb(20, 20, 20))}
    ...
    function library:panel(options) 
        ...
        local items = cfg.items do 
            ...
            items.glow = library:create("ImageLabel", {
                ...
                ImageTransparency = 1 - themes.preset.glow_strength,
            ...
            }) library:apply_theme(items.glow, "glow", "ImageColor3") library:apply_theme(items.glow, "glow", "ImageTransparency")
            ...
            local button_inline2 = library:create("Frame", {
                ...
                BorderSizePixel = 0,
                BackgroundColor3 = rgb(255, 255, 255)
            }) library:apply_theme(button_inline2, "inline", "BackgroundColor3")
            
            local UIGradient = library:create("UIGradient", {
                Parent = button_inline2,
                Name = "",
                Rotation = 90,
                Color = rgbseq{
    ...
    function library:indicator() 
        ...
        local items = cfg.items; do 
            ...
            items.Inline2 = library:create( "Frame" , {
                ...
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.inline
            }); library:apply_theme(items.Inline2, "inline", "BackgroundColor3")
            ...
            items.Outline2 = library:create( "Frame" , {
                ...
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.outline
            }); library:apply_theme(items.Outline2, "outline", "BackgroundColor3")
            
            items.LowContrast2 = library:create( "Frame" , {
                ...
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.low_contrast
            }); library:apply_theme(items.LowContrast2, "low_contrast", "BackgroundColor3"); local image_holder = items.LowContrast2;
            
            items.Inline3 = library:create( "Frame" , {
                Parent = items.LowContrast2;
                Name = "\0";
                Position = dim2(0, 4, 0, 4);
                BorderColor3 = rgb(0, 0, 0);
                Size = dim2(1, -8, 1, -8);
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.inline
            }); library:apply_theme(items.Inline3, "inline", "BackgroundColor3")
            
            items.Outline3 = library:create( "Frame" , {
                Parent = items.Inline3;
                Name = "\0";
                Position = dim2(0, 1, 0, 1);
                BorderColor3 = rgb(0, 0, 0);
                Size = dim2(1, -2, 1, -2);
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.outline
            }); library:apply_theme(items.Outline3, "outline", "BackgroundColor3")
            
            items.LowContrast3 = library:create( "Frame" , {
                Parent = items.Outline3;
                Name = "\0";
                Position = dim2(0, 1, 0, 1);
                BorderColor3 = rgb(0, 0, 0);
                Size = dim2(1, -2, 1, -2);
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.low_contrast
            }); library:apply_theme(items.LowContrast3, "low_contrast", "BackgroundColor3")

            items.InfoTitle2 = library:create( "TextLabel" , {
                FontFace = library.font;
                TextColor3 = themes.preset.text;
                BorderColor3 = rgb(0, 0, 0);
                Text = "Info";
            ...
            library:create( "UIStroke" , {
                Parent = items.InfoTitle2
            });
            
            items.Accent2 = library:create( "Frame" , {
                Name = "\0";
                Parent = items.LowContrast3;
                BorderColor3 = rgb(0, 0, 0);
                Size = dim2(1, 0, 0, 2);
                BackgroundColor3 = themes.preset.accent;
                BorderSizePixel = 0;
            }); library:apply_theme(items.Accent2, "accent", "BackgroundColor3");
            
            items.Shadow = library:create( "Frame" , {
                AnchorPoint = vec2(0, 1);
                Parent = items.Accent2;
                Name = "\0";
            ...
            library:create( "UIGradient" , {
                Rotation = 90;
                Parent = items.Shadow;
                Color = rgbseq{rgbkey(0, rgb(80, 80, 80)), rgbkey(1, rgb(80, 80, 80))}
            });
            ...
            items.Inline4 = library:create( "Frame" , {
                Parent = image_holder;
                Name = "\0";
                ...
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.outline
            }); library:apply_theme(items.Inline4, "outline", "BackgroundColor3")
            
            items.Outline4 = library:create( "Frame" , {
                Parent = items.Inline4;
                Name = "\0";
                Position = dim2(0, 1, 0, 1);
                BorderColor3 = rgb(0, 0, 0);
                Size = dim2(1, -2, 1, -2);
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.inline
            }); library:apply_theme(items.Outline4, "inline", "BackgroundColor3")
            
            items.LowContrast4 = library:create( "Frame" , {
                Parent = items.Outline4;
                Name = "\0";
                Position = dim2(0, 1, 0, 1);
                BorderColor3 = rgb(0, 0, 0);
                Size = dim2(1, -2, 1, -2);
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.low_contrast
            }); library:apply_theme(items.LowContrast4, "low_contrast", "BackgroundColor3")

            items.Profile = library:create( "ImageLabel" , {
                BorderColor3 = rgb(0, 0, 0);
                Parent = items.LowContrast4;
    ...
    function library:window(properties)
        ...
        local UIGradient = library:create("UIGradient", {
            ...
            Rotation = 90,
            Color = rgbseq{
            rgbkey(0, rgb(80, 80, 80)),
            rgbkey(1, rgb(40, 40, 40))
        }
        })
        ...
        local UIGradient3 = library:create("UIGradient", {
            Parent = background,
            Name = "",
            Rotation = 90,
            Color = rgbseq{
        ...
        library:apply_theme(UIGradient3, "contrast", "Color") 
        ...
        local background2 = library:create("Frame", {
            Parent = inline2,
            Name = "",
            Size = dim2(1, -2, 1, -2),
            Position = dim2(0, 1, 0, 1),
        ...
        library.keybind_list = background2
        
        local UIGradient4 = library:create("UIGradient", {
            Parent = background2,
            Name = "",
            Rotation = 90,
            Color = rgbseq{
        ...
        library:apply_theme(UIGradient4, "contrast", "Color") 
        ...
        local main_window = library:panel({
            name = "Pylox", 
            size = dim2(0, 600, 0, 620),
            position = dim2(0, (camera.ViewportSize.X / 2) - 300, 0, (camera.ViewportSize.Y / 2) - 310),
        ...
        library:apply_theme(outline2, "outline", "BackgroundColor3") 
        ...
        library:apply_theme(inline3, "inline", "BackgroundColor3") 

        local background3 = library:create("Frame", {
            Parent = inline3,
            Name = "\0",
            Position = dim2(0, 1, 0, 1),
            BorderColor3 = rgb(0, 0, 0),
        ...
        library.section_holder = background3
        ...
        local UIGradient5 = library:create("UIGradient", {
            Parent = background3,
            Rotation = 90,
            Color = rgbseq{
                rgbkey(0, rgb(8, 8, 8)),
        ...
        library:apply_theme(UIGradient5, "contrast", "Color") 
        library:make_resizable(items.main_holder) 

        local watermark = library:watermark({default = os.date('Pylox - %b %d %Y - %H:%M:%S')})  

        task.spawn(function()
            while task.wait(1) do 
                watermark.change_text(os.date('Pylox - %b %d %Y - %H:%M:%S'))
            end 
        end) 

        local visuals_tab = library:tab({name = "Visuals"})
        local players_tab = library:tab({name = "Players"})
        local config_tab = library:tab({name = "Config"})
        local settings_tab = library:tab({name = "Settings"})
        local style_tab = library:tab({name = "Style"})

        local visuals_column = visuals_tab:column()
        local visuals_section = visuals_column:section({name = "ESP Preview"})
        
        local esp_preview = visuals_section:esp_preview({})
        
        local esp_settings = visuals_column:section({name = "ESP Settings"})
        esp_settings:toggle({name = "Enabled", flag = "Enabled", default = true, callback = function(bool)
            esp_preview.refresh_elements()
        end})
        esp_settings:toggle({name = "Boxes", flag = "Boxes", default = true, callback = function(bool)
            esp_preview.refresh_elements()
        end})
        esp_settings:dropdown({name = "Box Type", items = {"Corner", "Full"}, default = "Corner", flag = "Box_Type", callback = function()
            esp_preview.refresh_elements()
        end})
        esp_settings:colorpicker({name = "Box Color", flag = "Box_Color", color = themes.preset.accent, callback = function(color)
            esp_preview.refresh_elements()
        end})
        esp_settings:toggle({name = "Names", flag = "Names", default = true, callback = function(bool)
            esp_preview.refresh_elements()
        end})
        esp_settings:colorpicker({name = "Name Color", flag = "Name_Color", color = rgb(255, 255, 255)})
        esp_settings:toggle({name = "Healthbar", flag = "Healthbar", default = true, callback = function(bool)
            esp_preview.refresh_elements()
        end})
        esp_settings:colorpicker({name = "Health Low", flag = "Health_Low", color = rgb(255, 0, 0)})
        esp_settings:colorpicker({name = "Health High", flag = "Health_High", color = rgb(0, 255, 0)})
        esp_settings:toggle({name = "Distance", flag = "Distance", default = true, callback = function(bool)
            esp_preview.refresh_elements()
        end})
        esp_settings:colorpicker({name = "Distance Color", flag = "Distance_Color", color = rgb(255, 255, 255)})
        esp_settings:toggle({name = "Weapon", flag = "Weapon", default = true, callback = function(bool)
            esp_preview.refresh_elements()
        end})
        esp_settings:colorpicker({name = "Weapon Color", flag = "Weapon_Color", color = rgb(255, 255, 255)})

        local players_column = players_tab:column()
        local players_section = players_column:section({name = "Player List"})
        
        local playerlist = players_section:playerlist({})
        players_section:dropdown({name = "Priority", items = {"Enemy", "Priority", "Neutral", "Friendly"}, default = "Neutral", flag = "PLAYERLIST_DROPDOWN", callback = function(text)
            library.prioritize(text)
        end})

        local config_column = config_tab:column()
        local config_section = config_column:section({name = "Configurations"})
        ...
        config_section:button({name = "Create", callback = function()
            ...
            library:notification({text = "Created Config: " .. flags["config_name_text_box"], time = 2})
        end})
        config_section:button({name = "Delete", callback = function()
            delfile(library.directory .. "/configs/" .. flags["config_name_list"] .. ".cfg")
            library:config_list_update()
            library:notification({text = "Deleted Config: " .. flags["config_name_list"], time = 2})
        end})
        config_section:button_holder({})
        config_section:button({name = "Load", callback = function()
            library:load_config(readfile(library.directory .. "/configs/" .. flags["config_name_list"] .. ".cfg"))
            library:notification({text = "Loaded Config: " .. flags["config_name_list"], time = 2})
        end})
        config_section:button({name = "Save", callback = function()
            ...
            library:config_list_update()
            library:notification({text = "Saved Config: " .. flags["config_name_list"], time = 2})
        end})
        config_section:button_holder({})
        ...
        local ui_section = settings_column:section({name = "UI Settings"})
        
        ui_section:keybind({callback = window.set_menu_visibility, key = Enum.KeyCode.Insert, name = "Menu Key"})
        ui_section:toggle({name = "Keybind List", flag = "keybind_list", default = false, callback = function(bool)
            library.keybind_list_frame.Visible = bool
        end})
        ui_section:toggle({name = "Watermark", flag = "watermark", default = true, callback = function(bool)
            watermark.set_visible(bool)
        end})
        ui_section:slider({name = "Glow Strength", flag = "Glow_Strength", min = 0, max = 1, default = 0.5, interval = 0.01, callback = function(value)
            library.update_glow_strength(value)
        end})
        ui_section:slider({name = "Blur Size", flag = "Blur Size", min = 0, max = 56, default = 15, interval = 1, callback = function(int)
            if window.opened then 
                blur.Size = int
            end
        end})
        
        local utility_section = settings_column:section({name = "Utility"})
        utility_section:button_holder({})
        utility_section:button({name = "Copy JobId", callback = function()
            setclipboard(game.JobId)
            library:notification({text = "Copied Job ID", time = 2})
        end})
        utility_section:button_holder({})
        utility_section:button({name = "Copy GameID", callback = function()
            setclipboard(game.GameId)
            library:notification({text = "Copied Game ID", time = 2})
        end})
        utility_section:button_holder({})
        utility_section:button({name = "Copy Join Script", callback = function()
            setclipboard('game:GetService("TeleportService"):TeleportToPlaceInstance(' .. game.PlaceId .. ', "' .. game.JobId .. '", game.Players.LocalPlayer)')
            library:notification({text = "Copied Join Script", time = 2})
        end})
        utility_section:button_holder({})
        utility_section:button({name = "Rejoin", callback = function()
            game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, lp)
        end})
        utility_section:button_holder({})
        utility_section:button({name = "Join New Server", callback = function()
            ...
            if data.playing <= (flags["max_players"] or 15) then 
                game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, data.id)
            end 
        end})
        utility_section:slider({name = "Max Players", flag = "max_players", min = 0, max = 40, default = 15, interval = 1})
        utility_section:button_holder({})
        utility_section:button({name = "Unload Menu", callback = function()
            for _, gui in library.guis do 
                gui:Destroy() 
            end 
        ...
        local theme_section = style_column:section({name = "Theme Colors"})
        
        theme_section:label({name = "Accent"})
        theme_section:colorpicker({name = "Accent Color", color = themes.preset.accent, flag = "accent", callback = function(color)
            library:update_theme("accent", color)
        end})
        theme_section:label({name = "Background"})
        theme_section:colorpicker({name = "Outline", color = themes.preset.outline, callback = function(color)
            library:update_theme("outline", color)
        end})
        theme_section:colorpicker({name = "Inline", color = themes.preset.inline, callback = function(color)
            library:update_theme("inline", color)
        end})
        theme_section:label({name = "Contrast"})
        theme_section:colorpicker({name = "Low Contrast", color = themes.preset.low_contrast, flag = "low_contrast", callback = function(color)
        ...
        theme_section:colorpicker({name = "High Contrast", color = themes.preset.high_contrast, flag = "high_contrast", callback = function(color)
            library:update_theme("contrast", rgbseq{
                rgbkey(0, flags["low_contrast"].Color),
                rgbkey(1, flags["high_contrast"].Color)
            })
        ...
        theme_section:label({name = "Text"})
        theme_section:colorpicker({name = "Text Color", color = themes.preset.text, callback = function(color)
            library:update_theme("text", color)
        end})
        theme_section:colorpicker({name = "Text Outline", color = themes.preset.text_outline, callback = function(color)
            library:update_theme("text_outline", color)
        end})
        theme_section:label({name = "Effects"})
        theme_section:colorpicker({name = "Glow Color", color = themes.preset.glow, callback = function(color)
            library:update_theme("glow", color)
        end})

        visuals_tab.open_tab()
    ...
    function library:watermark(options) 
        local cfg = {
            default = options.text or options.default or os.date('Pylox | %b %d %Y | %H:%M')
        }
    ...
    function library:esp_preview(properties)
        ...
        function cfg.refresh_elements( )                                
            ...
            for _, corner in objects[ "corners" ]:GetChildren() do
                if corner:FindFirstChildOfClass("Frame") then
                    corner:FindFirstChildOfClass("Frame").BackgroundColor3 = flags["Box_Color"].Color
                end
            end
        end
    ...
    function library:multi_section(options)
        ...
        local UIGradient = library:create("UIGradient", {
            ...
            Name = "",
            Rotation = 90,
            Color = rgbseq{rgbkey(0, rgb(80, 80, 80)), rgbkey(1, rgb(40, 40, 40))}
        }) 
        ...
        for _, tab in next, cfg.names do 
            ...
            function multi:open_tab(bool) 
                ...
                UIGradient3.Rotation = bool and -90 or 90
    ...
    function library:colorpicker(options)
        ...
        local outline3 = library:create("Frame", {
            Parent = visualize,
            Size = dim2(1, -2, 1, -2),
            Name = "outline",
            Active = true,
            ...
            BorderSizePixel = 0,
            BackgroundColor3 = themes.preset.outline
        }) library:apply_theme(outline3, "outline", "BackgroundColor3") 
        
        local visualize2 = library:create("Frame", {
            Parent = outline3,
            Size = dim2(1, -2, 1, -2),
            Name = "visualize",
            Active = true,
        ...
        local outline4 = library:create("Frame", {
            ...
            BorderSizePixel = 0,
            BackgroundColor3 = themes.preset.outline
        }) library:apply_theme(outline4, "outline", "BackgroundColor3") 
        ...
        local UIGradient6 = library:create("UIGradient", {
            Parent = sat,
            Rotation = 270,
            Transparency = numseq{
                numkey(0, 0),
        ...
        local UIGradient7 = library:create("UIGradient", {
            Parent = val,
            Transparency = numseq{
                numkey(0, 0),
                numkey(1, 1)
        ...
        function cfg.set(color, alpha)
            ...
            local offset2 = (a < 1) and 0 or -4
            alpha_picker.Position = dim2(a, offset2, 0, 0)
            alpha_drag.BackgroundColor3 = Color3.fromHSV(h, s, v)
            visualize2.BackgroundColor3 = Color
    ...
    function library:dropdown(options)
        ...
        if not cfg.scrolling then 
            background2 = library:create("Frame", {
                Parent = inline2,
                BorderColor3 = rgb(0, 0, 0),
                Name = "background",
                BackgroundTransparency = 1,
            ...
            library:apply_theme(background2, "accent", "BackgroundColor3") 
        else 
            background2 = library:create("ScrollingFrame", {
                Parent = inline2,
                BorderColor3 = rgb(0, 0, 0),
                Name = "background",
                BackgroundTransparency = 1,
            ...
            library:apply_theme(background2, "accent", "BackgroundColor3") 
            library:apply_theme(background2, "accent", "ScrollBarImageColor3") 
        end 
    ...
    function library:playerlist(options) 
        ...
        function cfg.create_player(player) 
            ...
            local UIPadding3 = library:create("UIPadding", {
                Parent = TextButton,
                Name = "",
                PaddingRight = dim(0, 2),
                PaddingLeft = dim(0, 2)
    ...
    library:update_glow_strength(themes.preset.glow_strength)

    return library, themes;
end)()

local ui = library:window({name = "Pylox"})
ui.set_menu_visibility(true)